 ...
 * <p>
 * This message type is used for responses and communications generated by AI assistants
 * or automated components within the system. It extends the base message functionality
 * with the ability to include tool calls that the assistant may invoke as part of its
 * response.
 * </p>
 * <p>
...
public class AssistantMessage extends BaseMessage {
	 ...
	 * identifies this message as originating from an assistant.
	 * </p>
