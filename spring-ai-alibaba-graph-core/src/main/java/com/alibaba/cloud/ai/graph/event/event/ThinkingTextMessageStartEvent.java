 ...
 * <p>
 * This event is fired when a system or AI component begins generating text content as
 * part of its thinking or reasoning phase. It marks the start of internal deliberation
 * text that provides transparency into the decision-making process and prepares consumers
 * for subsequent thinking content.
 * </p>
 * <p>
...
public class ThinkingTextMessageStartEvent extends BaseEvent {
	...
	/**
	 * Creates a new ThinkingTextMessageStartEvent with type set to
	 * {@link EventType#THINKING_TEXT_MESSAGE_START}.
	 * <p>
