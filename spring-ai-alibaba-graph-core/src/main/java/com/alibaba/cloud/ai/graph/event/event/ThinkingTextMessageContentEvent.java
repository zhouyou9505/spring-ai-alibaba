 ...
 * <p>
 * This event is fired when a system or AI component produces text output as part of its
 * internal reasoning process. Unlike regular text message content, this represents the
 * "thinking out loud" or internal deliberation that may be shared with users to provide
 * transparency into the decision-making process.
 * </p>
 * <p>
 * The event automatically sets its type to
 * {@link EventType#THINKING_TEXT_MESSAGE_CONTENT} and can carry the actual thinking
 * content through the inherited {@link com.alibaba.cloud.ai.dashscope.event.event.BaseEvent#setRawEvent(Object)} method.
 * </p>
 *
...
public class ThinkingTextMessageContentEvent extends BaseEvent {
	...
	/**
	 * Creates a new ThinkingTextMessageContentEvent with type set to
	 * {@link EventType#THINKING_TEXT_MESSAGE_CONTENT}.
	 * <p>
