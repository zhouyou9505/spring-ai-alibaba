 ...
 * <p>
 * This event is fired when arguments for a tool call are being streamed or built
 * incrementally. It allows for real-time tracking of tool call argument construction,
 * particularly useful in scenarios where complex arguments are being generated
 * progressively by an AI system.
 * </p>
 * <p>
 * The event automatically sets its type to {@link EventType#TOOL_CALL_ARGS} and provides
 * fields to identify the specific tool call and deliver argument content incrementally
 * through deltas.
 * </p>
 *
