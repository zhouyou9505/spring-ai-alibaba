 ...
 * <p>
 * This event is fired when a tool call has finished executing, marking the end of the
 * tool invocation lifecycle. It serves as a completion marker for tool call operations,
 * allowing consumers to know when the tool has finished processing and results are
 * available.
 * </p>
 * <p>
 * The event automatically sets its type to {@link EventType#TOOL_CALL_END} and identifies
...
public class ToolCallEndEvent extends BaseEvent {
	 ...
	 * <p>
	 * The timestamp is automatically set to the current time and the tool call ID is
	 * initialized as null.
	 * </p>
	 */
