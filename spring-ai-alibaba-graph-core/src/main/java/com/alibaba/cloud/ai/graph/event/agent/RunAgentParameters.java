 ...
 * <p>
 * RunAgentParameters provides a flexible way to configure agent execution through a
 * fluent builder interface. This class encapsulates the core configuration needed to run
 * an agent, including available tools, execution context, and optional properties.
 * <p>
 * The class follows the Builder pattern to provide a clean, readable API for constructing
 * parameter objects with optional components. Convenience factory methods are provided
...
public class RunAgentParameters {
	...
	/**
	 * Builder class for constructing RunAgentParameters instances using a fluent
	 * interface.
	 * <p>
	...
	public static class Builder {
		...
		/**
		 * Sets the forwarded properties object containing arbitrary additional
		 * configuration.
		...
		/**
		 * Constructs a new RunAgentParameters instance with the current builder
		 * configuration.
