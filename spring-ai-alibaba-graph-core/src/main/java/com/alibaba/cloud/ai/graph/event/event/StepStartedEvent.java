...
/**
 * An event that represents the initiation of a specific step within a process or
 * workflow.
 * <p>
 * This event is fired when an individual step in a larger execution sequence begins. It
 * provides granular tracking of progress within multi-step operations, allowing for
 * detailed monitoring and debugging of complex workflows.
 * </p>
 * <p>
 * The event automatically sets its type to {@link EventType#STEP_STARTED} and captures
 * the name of the step being initiated for identification purposes.
 * </p>
 *
