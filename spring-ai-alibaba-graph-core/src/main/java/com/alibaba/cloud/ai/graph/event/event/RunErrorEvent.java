 ...
 * <p>
 * This event is fired when an error occurs during the execution of a process, operation,
 * or run cycle. It captures the error information to enable proper error handling and
 * reporting throughout the application.
 * </p>
 * <p>
 * The event automatically sets its type to {@link EventType#RUN_ERROR} and provides a
...
public class RunErrorEvent extends BaseEvent {
	 ...
	 * <p>
	 * The timestamp is automatically set to the current time and the error field is
	 * initialized as null.
	 * </p>
	 */
