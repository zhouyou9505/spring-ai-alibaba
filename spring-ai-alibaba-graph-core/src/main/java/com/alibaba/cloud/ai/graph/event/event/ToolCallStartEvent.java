 ...
 * <p>
 * This event is fired when a tool call begins execution, marking the start of the tool
 * invocation lifecycle. It provides essential metadata about the tool call including its
 * identifier, the name of the tool being invoked, and the parent message that triggered
 * the tool call.
 * </p>
 * <p>
 * The event automatically sets its type to {@link EventType#TOOL_CALL_START} and
 * establishes the context for the tool call execution that will follow.
 * </p>
 *
...
public class ToolCallStartEvent extends BaseEvent {
	...
	/**
	 * Creates a new ToolCallStartEvent with type set to
	 * {@link EventType#TOOL_CALL_START}.
	 * <p>
