 ...
 * <p>
 * This event is fired when a text message begins streaming, marking the start of an
 * incremental message delivery process. It provides initial metadata about the message
 * including its identifier and the role of the sender, which helps consumers prepare for
 * subsequent content chunks.
 * </p>
 * <p>
 * The event automatically sets its type to {@link EventType#TEXT_MESSAGE_START} and
...
public class TextMessageStartEvent extends BaseEvent {
	...
	/**
	 * Creates a new TextMessageStartEvent with type set to
	 * {@link EventType#TEXT_MESSAGE_START}.
	 * <p>
