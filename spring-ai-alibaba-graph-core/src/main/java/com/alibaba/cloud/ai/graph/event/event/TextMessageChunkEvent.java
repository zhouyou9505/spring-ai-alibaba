 ...
 * <p>
 * This event is typically used in streaming scenarios where text messages are delivered
 * incrementally in chunks rather than as complete messages. Each chunk contains a portion
 * of the message content along with metadata to identify the message and the role of the
 * sender.
 * </p>
 * <p>
 * The event automatically sets its type to {@link EventType#TEXT_MESSAGE_CHUNK} and
 * provides fields to track the message identifier, sender role, and the incremental text
 * content (delta).
 * </p>
 *
...
public class TextMessageChunkEvent extends BaseEvent {
	...
	/**
	 * Creates a new TextMessageChunkEvent with type set to
	 * {@link EventType#TEXT_MESSAGE_CHUNK}.
	 * <p>
