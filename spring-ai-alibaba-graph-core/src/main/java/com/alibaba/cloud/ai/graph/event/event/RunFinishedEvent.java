 ...
 * <p>
 * This event is fired when a process, operation, or run cycle completes successfully. It
 * captures essential information about the completed run including identifiers for
 * tracking and the result of the execution.
 * </p>
 * <p>
 * The event automatically sets its type to {@link EventType#RUN_FINISHED} and provides
 * fields to store the thread ID, run ID, and execution result.
 * </p>
 *
