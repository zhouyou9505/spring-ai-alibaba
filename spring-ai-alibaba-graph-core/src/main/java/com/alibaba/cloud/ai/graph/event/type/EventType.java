package com.alibaba.cloud.ai.graph.event.type;

/**
 * Enumeration of all supported event types in the AGUI system.
 * <p>
 * This enum defines the complete set of event types that can occur within the
 * application, covering various categories including text messages, thinking processes,
 * tool calls, state management, and execution lifecycle events. Each event type
 * represents a specific kind of system activity or communication.
 * </p>
 * <p>
