 ...
 * <p>
 * This event is fired when there are incremental changes to the system state that need to
 * be communicated or processed. Unlike full state snapshots, this event represents only
 * the changes (deltas) that have occurred.
 * </p>
 * <p>
