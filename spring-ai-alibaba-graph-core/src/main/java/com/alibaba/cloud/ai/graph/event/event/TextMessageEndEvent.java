 ...
 * <p>
 * This event is fired when a text message has finished streaming and no more content
 * chunks or updates are expected. It serves as a completion marker for streaming message
 * scenarios, allowing consumers to know when message assembly is complete.
 * </p>
 * <p>
 * The event automatically sets its type to {@link EventType#TEXT_MESSAGE_END} and
...
public class TextMessageEndEvent extends BaseEvent {
	...
	/**
	 * Creates a new TextMessageEndEvent with type set to
	 * {@link EventType#TEXT_MESSAGE_END}.
	 * <p>
	 * The timestamp is automatically set to the current time and the message ID is
	 * initialized as null.
	 * </p>
	 */
