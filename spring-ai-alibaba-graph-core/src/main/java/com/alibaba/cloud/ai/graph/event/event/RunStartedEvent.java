 ...
 * <p>
 * This event is fired when a process, operation, or run cycle begins execution. It
 * captures essential tracking information including the thread and run identifiers to
 * enable monitoring and correlation with subsequent events in the execution lifecycle.
 * </p>
 * <p>
 * The event automatically sets its type to {@link EventType#RUN_STARTED} and provides
...
public class RunStartedEvent extends BaseEvent {
	 ...
	 * <p>
	 * The timestamp is automatically set to the current time and both identifier fields
