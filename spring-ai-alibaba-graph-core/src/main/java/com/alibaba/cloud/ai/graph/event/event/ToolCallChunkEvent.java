 ...
 * <p>
 * This event is fired when tool call information is being delivered incrementally in
 * chunks, typically during streaming scenarios where tool calls are being constructed
 * progressively. It provides comprehensive metadata about the tool call including its
 * identifier, name, parent message context, and incremental content data.
 * </p>
 * <p>
 * The event automatically sets its type to {@link EventType#TOOL_CALL_CHUNK} and enables
 * detailed tracking of tool call construction with full context information for
...
public class ToolCallChunkEvent extends BaseEvent {
	...
	/**
	 * Creates a new ToolCallChunkEvent with type set to
	 * {@link EventType#TOOL_CALL_CHUNK}.
	 * <p>
	 * The timestamp is automatically set to the current time and all fields are
	 * initialized as null.
	 * </p>
	 */
