 ...
 * <p>
 * This event is typically used to capture and transmit the current state of all messages
 * in the system. It contains a collection of {@link BaseMessage} objects that represent
 * the complete message history or a filtered subset at the time the snapshot was taken.
 * </p>
 * <p>
 * The event automatically sets its type to {@link EventType#MESSAGES_SNAPSHOT} and
...
public class MessagesSnapshotEvent extends BaseEvent {
	...
	/**
	 * Creates a new MessagesSnapshotEvent with type set to
	 * {@link EventType#MESSAGES_SNAPSHOT}.
	 * <p>
	 * The timestamp is automatically set to the current time and the messages list is
	 ...
	 * @param messages the list of messages to include in this snapshot. Can be null or
	 * empty.
	 */
