 ...
 * <p>
 * This message type is used to communicate the results of tool calls back to the system.
 * It contains the output from tool executions, whether successful results or error
 * information. The tool call identifier links this message back to the original tool
 * invocation for proper correlation.
 * </p>
 * <p>
 * Tool messages can contain either successful execution results in the inherited content
 * field, or error information when tool execution fails. This allows for comprehensive
...
public class ToolMessage extends BaseMessage {
	 ...
	 * identifies this message as originating from a tool execution.
	 * </p>
