 ...
 * <p>
 * This event is fired when a tool call has finished executing and carries the result
 * content along with metadata for correlation and context. It provides the output from
 * the tool execution along with identifiers to link the result back to the original tool
 * call and associated messages.
 * </p>
 * <p>
 * The event automatically sets its type to {@link EventType#TOOL_CALL_RESULT} and
 * includes comprehensive information about the tool call result including content,
...
public class ToolCallResultEvent extends BaseEvent {
	...
	/**
	 * Creates a new ToolCallResultEvent with type set to
	 * {@link EventType#TOOL_CALL_RESULT}.
	 * <p>
