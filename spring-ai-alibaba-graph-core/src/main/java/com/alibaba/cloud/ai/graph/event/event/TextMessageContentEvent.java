 ...
 * <p>
 * This event is used to deliver incremental content updates for text messages, typically
 * in streaming scenarios where message content is built up over time. Unlike
 * {@link com.alibaba.cloud.ai.dashscope.event.event.TextMessageChunkEvent}, this event focuses specifically on content delivery
 * without role information.
 * </p>
 * <p>
 * The event automatically sets its type to {@link EventType#TEXT_MESSAGE_CONTENT} and
...
public class TextMessageContentEvent extends BaseEvent {
	...
	/**
	 * Creates a new TextMessageContentEvent with type set to
	 * {@link EventType#TEXT_MESSAGE_CONTENT}.
	 * <p>
	 * The timestamp is automatically set to the current time and both fields are
	 * initialized as null.
	 * </p>
	 */
