 ...
 * <p>
 * This class provides common functionality for messages including unique identification,
 * content storage, and naming. All concrete message implementations must extend this base
 * class and provide their specific role implementation. The class automatically generates
 * a unique UUID for new messages when using the default constructor.
 * </p>
 * <p>
 * Messages are fundamental building blocks for communication within the system, whether
 * between users, AI assistants, or system components.
 * </p>
 *
 */
public abstract class BaseMessage {
	 ...
	 * <p>
	 * This abstract method must be implemented by concrete message classes to define
	 * their specific role (e.g., "user", "assistant", "system").
	 * </p>
