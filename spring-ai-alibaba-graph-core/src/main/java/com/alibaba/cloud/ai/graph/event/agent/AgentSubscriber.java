...
/**
 * Interface for subscribing to agent lifecycle events, state changes, and real-time
 * updates.
 * <p>
 * AgentSubscriber provides a comprehensive set of callback methods that allow
 * implementers to monitor and react to various aspects of agent execution, including:
 * <ul>
...
public interface AgentSubscriber {
	 ...
	 * <p>
	 * This method is invoked at the start of the agent execution lifecycle, providing
	 * access to the initial parameters and context.
	 ...
	 * <p>
	 * This method provides both the run parameters and the specific error that caused the
	 * failure, allowing for error handling and recovery.
	 * @param params the parameters and context for this agent run
	 ...
	 * <p>
	 * This method is always invoked at the end of the agent execution lifecycle, making
	 * it suitable for cleanup operations and resource management.
	 * @param params the parameters and context for this agent run
	 */
	 ...
	 * <p>
	 * This is a catch-all method that receives all events. It's useful for logging,
	 * debugging, or when you need to handle all event types uniformly.
	 ...
	 * <p>
	 * This method may be called multiple times for a single message as content is
	 ...
	 * <p>
	 * This method may be called multiple times for a single tool call as arguments are
	 * generated incrementally.
	 ...
	 * <p>
	 * State snapshots provide a complete view of the agent's current state at a specific
	 * point in time.
	 ...
	 * <p>
	 * State deltas provide only the changes that occurred since the last state update,
	 * enabling efficient state tracking.
	 ...
	 * <p>
	 * Message snapshots provide a complete view of all messages in the conversation at a
	 ...
	 * <p>
	 * Raw events provide access to the original event data before any processing or
	 * transformation by the agui4j framework.
	 ...
	 * <p>
	 * Custom events allow for application-specific event handling and extensibility
	 * beyond the core event types.
	 ...
	 * <p>
	 * This method is invoked whenever new messages are added to the conversation or
	 ...
	 * <p>
	 * This method is invoked whenever the agent's state is updated, providing a way to
	 ...
	 * <p>
	 * This method provides direct access to the new message without requiring access to
	 * the full agent parameters.
	 ...
	 * <p>
	 * This method provides direct access to the tool call without requiring access to the
	 * full agent parameters.
